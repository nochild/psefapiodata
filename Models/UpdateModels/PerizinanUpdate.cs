...
namespace PsefApiOData.Models
{
    ...
    public class PerizinanUpdate
    {
        ...
        public string TanggalPerubahanIzin { get; set; }

        /// <summary>
        /// Gets or sets the Perizinan Status Active.
        /// </summary>
        /// <value>The Perizinan's Status Active.</value>
        public uint? StatusActive { get; set; }
    }
}
